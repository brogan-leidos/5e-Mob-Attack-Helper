...
function setVisibleStatBlock(monster) {
    ...
    document.getElementsByClassName('statBlockContainer')[0].style.background = `url(https://5e.tools/img/bestiary/MM/${monster['name']}.jpg) center -20px / cover no-repeat rgba(249, 249, 235, 0.75)`;
}
...
function addExtraAttack(mobTag, defaultWeapon=true) {
    ...
    var htmlToHitInsert = `<tr style="${style}"><td><button id="${mobTag}-Weapon-Delete-${weaponNum}" class="weaponDeleteButton" title="Delete this weapon from the mob"><i class="fa fa-trash-o"></i></button></td><td>Bonus To Hit:</td><td><input id="${mobTag}-ToHit-${weaponNum}" type="number" value="0"></td></tr>`;
...
function resetPromptNotificationHighlighting() {
    document.getElementById("resultsNotification").style.color = "var(--menu-dark)";
