...
async function launchAttack() {
    ...
    for (var block=0; block < rollArray.length; block++) {
        ...
        infoAppend += `<span class="mobHeader" id="${attacker.MobName}-Result"> <i class="glyphicon glyphicon-triangle-bottom"></i> ${attacker.Icon} ${attacker.Name} : ${blockNumHits} hits`;
