...
<table class="mobBlock">
  <tbody>
    ...
    <tr>
      <td><span id="FILLER-BLOCK-Move-Up" class="fa fa-angle-double-up mobMoveButton" style="cursor:pointer"></span></td>
      <td>Number:</td>
      <td><input id="FILLER-BLOCK-Number" type="number" value="1" /></td>
    </tr>
    <tr>
      <td><span id="FILLER-BLOCK-Move-Down" class="fa fa-angle-double-down mobMoveButton" style="cursor:pointer"></span></td>
